      ...
      <section className='container'>
        <div className='flex flex-col md:flex-row gap-10 md:gap-5'>
          ...
          <div className='flex-1 flex flex-col justify-center text-center md:text-left md:p-10 gap-5 relative'>
            <h1 style={ClashDisplay.style} className='leading-tight text-[20px] md:text-[26px] lg:text-[32px]'>Introduction to getlinked<br />tech Hackathon<span className='text-primary'>1.0</span></h1>
            <p className='max-w-[250px] sm:max-w-none mx-auto text-[13px] md:text-[14px]'>Our tech hackathon is a melting pot of visionaries, and its purpose is as
